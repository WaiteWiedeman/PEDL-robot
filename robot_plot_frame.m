function [h1,h2]=robot_plot_frame(Xcg_pred,Ycg,cartHalfLen,Xcg,xend1,yend1,xend2,yend2,xpend1,ypend1,xpend2,ypend2)
    % True system
    % cart
    ...
    % plots rod and blob
    h1 = plot([Xcg xend1],[Ycg yend1],'k','LineWidth', 3, 'LineStyle','-', "DisplayName", "Reference"); 
